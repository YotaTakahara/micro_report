...
VL_MODULE(Vtop) {
  public:
    ...
    VL_SIG(top__DOT__rs1_data,31,0);
    ...
    VL_SIG(top__DOT__alu1__DOT__op1_abs,31,0);
    VL_SIG(top__DOT__alu1__DOT__op2_abs,31,0);
    ...
    VL_SIG64(top__DOT__alu1__DOT__mul_ans,63,0);
    ...
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    VL_SIG8(__Vfunc_top__DOT__data_mem1__DOT__read__2__alucode,5,0);
    VL_SIG8(__Vclklast__TOP__cpu_resetn,0,0);
    VL_SIG8(__Vclklast__TOP__sysclk,0,0);
    VL_SIG(__Vfunc_top__DOT__alu1__DOT__abs__0__Vfuncout,31,0);
    VL_SIG(__Vfunc_top__DOT__alu1__DOT__abs__0__tmp,31,0);
    VL_SIG(__Vfunc_top__DOT__alu1__DOT__abs__1__Vfuncout,31,0);
    VL_SIG(__Vfunc_top__DOT__alu1__DOT__abs__1__tmp,31,0);
    VL_SIG(__Vfunc_top__DOT__data_mem1__DOT__read__2__Vfuncout,31,0);
    VL_SIG(__Vfunc_top__DOT__data_mem1__DOT__read__2__r_addr,31,0);
